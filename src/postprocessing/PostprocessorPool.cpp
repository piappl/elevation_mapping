...
PostprocessorPool::PostprocessorPool(std::size_t poolSize, std::shared_ptr<rclcpp::Node>& nodeHandle)
{
  ...
  nodeHandle->declare_parameter("postprocessor_pipeline_name", rclcpp::ParameterValue(std::string("postprocessor_"
                                                                                                  "pipeline")));
...
void PostprocessorPool::wrapTask(size_t serviceIndex)
{
  ...
  {
    RCLCPP_ERROR_STREAM(rclcpp::get_logger("my_logger"), "Postprocessor pipeline, thread "
                                                             << serviceIndex
